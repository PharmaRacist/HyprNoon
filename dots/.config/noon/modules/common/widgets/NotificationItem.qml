...
Item { // Notification item area
    ...
    Rectangle { // Background of notification item
        ...
        color: (expanded && !onlyNotification) ? (notificationObject.urgency == NotificationUrgency.Critical) ? ColorUtils.mix(Colors.colSecondaryContainer, Colors.colLayer2, 0.35) : (Colors.colSurfaceContainerHigh) : ColorUtils.transparentize(Colors.colSurfaceContainerHighest)
